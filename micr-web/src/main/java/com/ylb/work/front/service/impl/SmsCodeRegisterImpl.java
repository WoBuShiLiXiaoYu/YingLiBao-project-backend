...
public class SmsCodeRegisterImpl implements SmsService {
    ...
    public boolean sendSms(String phone) {
        ...
        System.out.println("注册验证码: random = " + random);
        content = String.format(content, random);
    ...
    // post 请求
    public CloseableHttpResponse postMethod(CloseableHttpClient httpClient, String uri, String content, String phone, String appCode) throws Exception {
        // 创建 HttpClient 对象
        // CloseableHttpClient httpClient = HttpClients.createDefault();
        CloseableHttpResponse response = null;
        // 创建 Post 对象
    ...
    // get 请求，返回 response
    public CloseableHttpResponse getMethod(CloseableHttpClient httpClient, String uri, String content, String phone, String appCode) throws IOException {
        // 拼接 url
        String url = CommonUtil.pieceUrl(uri, content, phone);
